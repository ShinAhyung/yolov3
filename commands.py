...
def clone():
    ...
    subprocess.Popen(['git', 'clone', "git@github.com:" + __user__ + "/" + __repo__ + ".git", local_path])
...
#    choices = 'clone, add, commit, branch, pull, fetch, merge, reset, blame and stash'
    ...
    4) branch: git branch {branch name}
    5) pull: git pull
    ...
    elif choose_command == "add" or choose_command == "1":
        add()

    elif choose_command == "commit" or choose_command == "2":
        commit()

    elif choose_command == "push" or choose_command == "3":
        push()

    elif choose_command == "branch" or choose_command == "4":
        branch()

    elif choose_command == "pull" or choose_command == "5":
        pull()

    elif choose_command == "fetch":
        fetch()

    elif choose_command == "merge" or choose_command == "6":
        merge()
